...
|:--------:|:------:|:--------:|
| Windows | Installer | [**RateMe_1.1.0-2.exe**](../../releases/download/v1.1.0-2/RateMe_1.1.0-2.exe) |
| Windows | Portable | [**RateMe_1.1.0-2_portable.zip**](../../releases/download/v1.1.0-2/RateMe_1.1.0-2_portable.zip) |
| macOS | Universal | [**RateMe_1.1.0-2.dmg**](../../releases/download/v1.1.0-2/RateMe_1.1.0-2.dmg) |

### Linux Packages

| Format | Architecture | Download |
|:------:|:-----------:|:--------:|
| AppImage | x86_64 | [**RateMe_1.1.0-2.AppImage**](../../releases/download/v1.1.0-2/RateMe_1.1.0-2.AppImage) |
| DEB | amd64 | [**RateMe_1.1.0-2_amd64.deb**](../../releases/download/v1.1.0-2/RateMe_1.1.0-2_amd64.deb) |
| RPM | x86_64 | [**RateMe_1.1.0-2_x86_64.rpm**](../../releases/download/v1.1.0-2/RateMe_1.1.0-2_x86_64.rpm) |
| Flatpak | Universal | [**RateMe_1.1.0-2.flatpak**](../../releases/download/v1.1.0-2/RateMe_1.1.0-2.flatpak) |
...
|:--------:|:-------:|:--------:|
| Android | Universal | [**RateMe_1.1.0-2.apk**](../../releases/download/v1.1.0-2/RateMe_1.1.0-2.apk) |
| Android | arm64-v8a | [**RateMe_1.1.0-2_arm64-v8a.apk**](../../releases/download/v1.1.0-2/RateMe_1.1.0-2_arm64-v8a.apk) |
| Android | armeabi-v7a | [**RateMe_1.1.0-2_armeabi-v7a.apk**](../../releases/download/v1.1.0-2/RateMe_1.1.0-2_armeabi-v7a.apk) |
| Android | x86_64 | [**RateMe_1.1.0-2_x86_64.apk**](../../releases/download/v1.1.0-2/RateMe_1.1.0-2_x86_64.apk) |
| iOS | - | Coming soon |
...
### Windows
1. Installer: Run `RateMe_1.1.0-2.exe` and follow the installation wizard
   - Or -
2. Portable: Extract `RateMe_1.1.0-2_portable.zip` and run `RateMe.exe`
...
#### AppImage
1. Download `RateMe_1.1.0-2.AppImage`
2. Make it executable:
```bash
chmod +x RateMe_1.1.0-2.AppImage
```
3. Run it:
```bash
./RateMe_1.1.0-2.AppImage
```
No installation needed - the AppImage is portable and works on most Linux distributions.

#### DEB Package (Ubuntu/Debian)
```bash
sudo apt install ./RateMe_1.1.0-2_amd64.deb
```

#### RPM Package (Fedora/RHEL)
```bash
sudo dnf install ./RateMe_1.1.0-2_x86_64.rpm
```

#### Flatpak Installation

1. Download the Flatpak package from [releases](../../releases/download/v1.1.0-2/RateMe_1.1.0-2.flatpak)
...
3. Install RateMe:
```bash
flatpak install ./RateMe_1.1.0-2.flatpak
```
